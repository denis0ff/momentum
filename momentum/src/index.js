...
3. Смена фонового изображения +20  
   При загрузке или перезагрузке приложения фоновое изображение выбирается из расположенной на GitHub форкнутого репозитория [коллекции изображений](https://github.com/rolling-scopes-school/stage1-tasks/tree/assets/images).  
   - ссылка на фоновое изображение формируется с учётом времени суток и случайного номера изображения (от '01' до '20') +5 
   - изображения можно перелистывать кликами по стрелкам, расположенным по бокам экрана. +5 
...
5. Виджет цитата дня +10
   ...
   В качестве источника цитаты используется JSON-файл с цитатами и их авторами.
...
11. Дополнительный функционал +10  
   - ToDo List - список дел (как в оригинальном приложении - Бесплатная версия) +10
